...
model_path = r'C:\Users\Lenovo\Documents\Kuliah - UAJY\Semester V - 2024-2025\Pembelajaran mesin dan Pembelajaran Mendalam - A\Pertemuan 04 - Tugas 2\Tugas_A_12071'
...
st.write("Aplikasi ini berguna untuk membantu potensi penyakin jantung pada manusia berusia 21- - 79 tahun")
...
input_data = [[input_sex_F, input_sex_M, input_cpain_ASY,
               ...
               RestingBP, Cholesterol, input_fastbs,
               MaxHR, Old_peak]]
...
if st.button("Prediksi"):
    ...
    outcome = {
        0: 'Tidak Berpotensi Sakit Jantung',
        1: 'Berpotensi Sakit Jantung'
    }
